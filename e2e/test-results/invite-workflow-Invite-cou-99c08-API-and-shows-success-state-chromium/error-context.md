...
- Name: invite-workflow.spec.ts >> Invite counterparties workflow >> Req 5 — confirm & send posts to the API and shows success state
- Location: tests\invite-workflow.spec.ts:294:7
