...
- Name: invite-workflow.spec.ts >> Invite counterparties workflow >> Req 2 — add a group; group card appears in recipients
- Location: tests\invite-workflow.spec.ts:81:7
