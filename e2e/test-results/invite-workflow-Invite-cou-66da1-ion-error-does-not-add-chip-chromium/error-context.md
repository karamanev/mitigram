...
- Name: invite-workflow.spec.ts >> Invite counterparties workflow >> Req 4 — invalid email shows validation error, does not add chip
- Location: tests\invite-workflow.spec.ts:187:7
