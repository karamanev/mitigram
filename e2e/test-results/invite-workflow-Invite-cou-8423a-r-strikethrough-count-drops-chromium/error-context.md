...
- Name: invite-workflow.spec.ts >> Invite counterparties workflow >> Req 3 — exclude a group member; strikethrough + count drops
- Location: tests\invite-workflow.spec.ts:115:7
