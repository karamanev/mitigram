...
- Name: invite-workflow.spec.ts >> Invite counterparties workflow >> Req 4 — type ad-hoc email and press Enter; dashed chip appears
- Location: tests\invite-workflow.spec.ts:160:7
