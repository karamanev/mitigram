...
- Name: invite-workflow.spec.ts >> Invite counterparties workflow >> Back button in review panel returns to the main dialog
- Location: tests\invite-workflow.spec.ts:332:7
