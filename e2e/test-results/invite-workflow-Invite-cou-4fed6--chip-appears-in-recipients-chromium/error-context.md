...
- Name: invite-workflow.spec.ts >> Invite counterparties workflow >> Req 1 — add individual contact; chip appears in recipients
- Location: tests\invite-workflow.spec.ts:40:7
...
- generic [ref=e3]:
  ...
  - main [ref=e6]:
    - generic [ref=e7]:
      ...
      - button "Invite counterparties" [ref=e12] [cursor=pointer]
