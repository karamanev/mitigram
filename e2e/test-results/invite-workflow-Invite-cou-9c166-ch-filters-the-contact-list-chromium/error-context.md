...
- Name: invite-workflow.spec.ts >> Invite counterparties workflow >> Req 1 — address-book search filters the contact list
- Location: tests\invite-workflow.spec.ts:70:7
