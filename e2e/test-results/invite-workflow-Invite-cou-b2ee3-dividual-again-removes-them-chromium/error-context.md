...
- Name: invite-workflow.spec.ts >> Invite counterparties workflow >> Req 1 — clicking the selected individual again removes them
- Location: tests\invite-workflow.spec.ts:58:7
