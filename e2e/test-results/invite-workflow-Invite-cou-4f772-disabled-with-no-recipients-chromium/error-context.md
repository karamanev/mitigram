...
- Name: invite-workflow.spec.ts >> Invite counterparties workflow >> Send invitations button is disabled with no recipients
- Location: tests\invite-workflow.spec.ts:325:7
